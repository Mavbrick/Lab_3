...
tests = [ {'description': 'PINA: 0x00 => PORTB: 0x00 , PORTC: 0x00',
    ...
    {'description': 'PINA: 0x18 => PORTB: 0x01 , PORTC: 0x80',
    'steps': [ {'inputs': [('PINA',0x18)], 'iterations': 5 } ],
    ...
    {'description': 'PINA: 0x69 => PORTB: 0x06 , PORTC: 0x90',
    'steps': [ {'inputs': [('PINA',0x69)], 'iterations': 5 } ],
    'expected': [('PORTB', 0x06),('PORTC',0x90)],
    },
    {'description': 'PINA: 0xCA => PORTB: 0x0C , PORTC: 0xA0',
    'steps': [ {'inputs': [('PINA',0xCA)], 'iterations': 5 } ],
    'expected': [('PORTB', 0x0C),('PORTC',0xA0)],
    },
    ]

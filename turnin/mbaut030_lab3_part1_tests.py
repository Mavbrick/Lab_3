...
tests = [ {'description': 'PINA: 0x01, PINB: 0x20 => PORTC: 0x02',
    'steps': [ {'inputs': [('PINA',0x01), ('PINB',0x20)], 'iterations': 5 } ],
    'expected': [('PORTC',0x02)],
    },
    ...
    {'description': 'PINA: 0x03, PINB: 0x70 => PORTC: 0x05',
    'steps': [ {'inputs': [('PINA',0x03), ('PINB',0x07)], 'iterations': 5 } ],
    'expected': [('PORTC',0x05)],
    },
